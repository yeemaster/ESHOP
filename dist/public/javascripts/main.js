define('zepto', [], function () {
    ...
    var Zepto = function () {
        ...
        var a, b, c, d, e = [], f = e.slice, g = window.document, h = {}, i = {}, j = g.defaultView.getComputedStyle, k = {
                ...
                'before',
                'append'
            ], o = g.createElement('table'), p = g.createElement('tr'), q = {
    ...
    window.Zepto = Zepto, '$' in window || (window.$ = Zepto), function (a) {
        ...
        a.each(g, function (a, e) {
            ...
            return a.isObject(c) && (d = c.easing, e = c.complete, c = c.duration), c && (c /= 1000), this.anim(b, c, d, e);
        ...
        function ajaxBeforeSend(a, b) {
            var c = b.context;
            if (b.beforeSend.call(c, a, b) === !1 || triggerGlobal(b, c, 'ajaxBeforeSend', [
                    a,
                    b
                ]) === !1)
                return !1;
            triggerGlobal(b, c, 'ajaxSend', [
                a,
                b
            ]);
        }
        function ajaxSuccess(a, b, c) {
            ...
            c.success.call(d, a, e, b), triggerGlobal(c, d, 'ajaxSuccess', [
                b,
                c,
                a
            ]), ajaxComplete(e, b, c);
        ...
        function ajaxError(a, b, c, d) {
            var e = d.context;
            d.error.call(e, c, b, a), triggerGlobal(d, e, 'ajaxError', [
                c,
                d,
                a
            ]), ajaxComplete(b, c, d);
        ...
        function ajaxComplete(a, b, c) {
            var d = c.context;
            c.complete.call(d, b, a), triggerGlobal(c, d, 'ajaxComplete', [
                b,
                c
            ]), ajaxStop(c);
        }
        ...
        doCarouselTouchCircle: function (myCarousel) {
            ...
            function tab() {
                ...
                if (now == items.length - 1) {
                    if (abtn[initposition])
                        abtn[initposition].className = 'active';
                } else if (now === 0) {
                    if (abtn[lastposition])
...
define('registermain', [
    ...
    return {
        deal_register_main: function () {
            ...
            passbuttonauto.onclick = function () {
                verify.getyzm(this);
            };
        }
    };
...
(function (win) {
    ...
    require([
        ...
        'registermain',
        'loginmain'
    ], function (indexmain, registermain, loginmain) {
        var selected = document.getElementsByTagName('body')[0].getAttribute('webtitle');
        console.log(selected);
        switch (selected) {
        case 'index_html':
            indexmain.deal_index_main();
            break;
        case 'register_html':
            registermain.deal_register_main();
            break;
        case 'login_html':
            loginmain.deal_login_main();
            break;
        default:
            break;
        }
